...
@ApiModel(description = "年度巡检计划统计")
@Table(name = "t_inspection_plan_year")
public class InspectionPlanYear  extends BaseRowModel{
	 /**
     * 年度巡检计划统计编号
     */
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @NotNull(groups = InspectionPlanYearUpdateChecks.class)
    @ApiModelProperty(value = "年度巡检计划统计编号(系统生成)", name = "id", required = false, example = "1")
    private Integer id;
    ...
    @NotNull(message = "实训室名称不能为空",groups = InspectionPlanYearCreateChecks.class)
    @Column(name = "room_id")
    ...
    public interface InspectionPlanYearCreateChecks {

    }

    public interface InspectionPlanYearUpdateChecks {
