...
@ApiModel(description = "汇总统计日表")
@Table(name = "t_summary_statistics_date")
public class SummaryStatisticsDate {
    /**
     * 汇总统计（系统自动生成）
     */
    @Id
    @NotNull(groups = SummaryStatisticsDateUpdateChecks.class)
    @ApiModelProperty(value = "汇总统计日表编号（系统生成）", name = "id", required = false, example = "1")
     ...
     * 统计日期 2020-05-23
     */
    @ApiModelProperty(value = "统计日期", name = "statisticsDate", required = false, example = "2020-05-23")
    ...
    public interface SummaryStatisticsDateChecks {}

    public interface SummaryStatisticsDateUpdateChecks {}
     ...
     * 获取统计日期 2020-05-23
     *
     * @return statistics_date - 统计日期 2020-05-23
     */
     ...
     * 设置统计日期 2020-05-23
     *
     * @param statisticsDate 统计日期 2020-05-23
     */
