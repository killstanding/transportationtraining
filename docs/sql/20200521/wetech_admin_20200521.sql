...
INSERT INTO `sys_resource` VALUES (5322, '教案修改', 'MENU', '#teachingplan/editpage', 532, '0/1/53/532/', 'teachingplan:*', 1, '', 1, 1);
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES (1, 'admin', '超级管理员', '11,21,31,41,46,59,69,70,83,5111,5112,5121,5122,5123,5211,5212,5221,5222,5311,5312,5321,5322,5331', 0);
...
-- ----------------------------
INSERT INTO `t_maintenance_record` VALUES (1, 'MR001', '丰田皇冠教具车维修单', 1, '1702060002007000104', '丰田皇冠教具车', '1', '教学用机电实验仪器', 'em_confirmed', '待确认', '1000', '张三', 1, '汽车工程系', 2, '1', '丰田T-TEP整车实训区', '2020-05-11 00:00:00', '无法开机', '问题截图', '/img/1.png', '2020-05-11 00:00:00', '2020-05-11 00:00:00', NULL);
