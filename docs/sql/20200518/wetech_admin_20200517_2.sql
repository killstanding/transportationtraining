/*
 ...
 Source Server         : 192.168.150.128_root
...
) ENGINE = InnoDB AUTO_INCREMENT = 5113 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '资源表' ROW_FORMAT = Compact;
...
INSERT INTO `sys_resource` VALUES (51, '设备管理', 'MENU', '#', 1, '0/1/', '', 1, '', NULL, 0);
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES (1, 'admin', '超级管理员', '11,21,31,41,46,69,70,83,5111,5112', 0);
