...
-- ----------------------------
INSERT INTO `t_collection_record` VALUES (1, 1, '发动机机油', '耗材', 'asset_type_consumables', '2020-03-23 00:00:00', '汽修系', 1, '车身电气系统课程', 1, '李旭', 1, '10', '2020-03-24 00:00:00', '无', '2020-04-22 16:52:00', '2020-04-22 16:52:00', 'ccr_write', '填写耗材申请单', '2020', 'admin', 1, '1', 'test', NULL, NULL);
...
CREATE TABLE `t_consumables`  (
  ...
  `position_code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '位置编号',
  `position_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '位置名称',
  `manager` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT ' ',
...
INSERT INTO `t_consumables` VALUES (2, 'CON202006202', '耗材测试', '2020-06-20', 'DEX-COOL', '5', NULL, '1', '丰田T-TEP整车实训区', 'admin', 1, '0', '0', '0', '0', '2020-06-20 10:29:28', '2020-06-20 10:29:28', '9', '发动机机油', NULL);
...
-- ----------------------------
INSERT INTO `t_course_arrangement` VALUES (2, 1, '2020年 第19周 (5月4日-5月10日)', '3-4', '汽车机械基础', 1, '北京交通运输职业学院', '1', NULL, 'teacher', 26, 'admin', 1, 'admin', 1, '丰田T-TEP整车实训区', 1, '构件静力分析讲义-1', 1, '12123123', 0, 0, '2020-06-14 09:42:16', '2020-06-14 09:42:16', 0);
INSERT INTO `t_course_arrangement` VALUES (3, 1, '2020年 第19周 (5月4日-5月10日)', '1-2', '测试课程', 3, '汽车工程系', '2', NULL, 'admin', 1, 'teacher', 26, 'teacher', 26, '丰田汽车实训室', 2, '测试课程', 2, '实训内容', 0, 0, '2020-06-15 08:47:34', '2020-06-15 08:47:34', 0);
INSERT INTO `t_course_arrangement` VALUES (4, 1, '2020年 第19周 (5月4日-5月10日)', '5-6', '测试课程', 3, '15汽检01', '11', NULL, 'admin', 1, 'admin', 1, 'teacher', 26, '吉利实训室', 3, '构件静力分析讲义-1', 1, '测试课程', 0, 0, '2020-06-20 11:09:00', '2020-06-20 11:09:00', 0);
...
-- ----------------------------
INSERT INTO `t_maintenance_record` VALUES (1, 'MR001', '丰田皇冠教具车维修单', 1, '1702060002007000104', '丰田皇冠教具车', '1', '教学用机电实验仪器', 'em_end', '维修完成', '2000', '张三', 1, '汽车工程系', 2, '1', '丰田T-TEP整车实训区', '2020-05-11 00:00:00', '无法开机', '问题截图', '/img/1.png', '2020-05-11 00:00:00', '2020-06-14 09:34:27', '2020', '', 0, '设备维修', ' equipment_maintenance');
INSERT INTO `t_maintenance_record` VALUES (2, 'MR202006142', '1231231', 1, NULL, '丰田皇冠教具车', '1', '教学用机电实验仪器', 'em_write', '填写设备维修单', NULL, 'admin', 1, '北京交通运输职业学院', 1, '1', '丰田T-TEP整车实训区', '2020-06-14', '12312312312', '部署遇到的问题', 'D:/result_dir/files/20200614/7c0ca2f552944bd88857e22b3d13b157.docx', '2020-06-14 09:36:08', '2020-06-14 09:38:29', '2020', 'admin', 1, '设备维修', ' equipment_maintenance');
...
-- Records of t_tools
-- ----------------------------
INSERT INTO `t_tools` VALUES (1, 'ZY2015000663', '1', '教学用机电实验仪器', '拆装工具', 7700, '2017-12-12', '1', 'YT-5530-YT-5542.YT-55442.YT55444.YT55452', 'admin', '1', '1', '丰田T-TEP整车实训区', '南校区汽车系', 1, '2020-04-22 16:52:00', '2020-04-22 16:52:00', NULL, NULL, NULL, NULL);
