...
CREATE TABLE `t_course_arrangement`  (
  ...
  `is_lock` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '是否锁定 0 否 1 是',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `t_course_arrangement` VALUES (2, 1, '2020年 第19周 (5月4日-5月10日)', '3-4', '汽车机械基础', 1, '北京交通运输职业学院', '1', NULL, 'teacher', 26, 'admin', 1, 'admin', 1, '丰田T-TEP整车实训区', 1, '构件静力分析讲义-1', 1, '12123123', 0, 0, '2020-06-14 09:42:16', '2020-06-14 09:42:16', 0, NULL);
INSERT INTO `t_course_arrangement` VALUES (3, 1, '2020年 第19周 (5月4日-5月10日)', '1-2', '测试课程', 3, '汽车工程系', '2', NULL, 'admin', 1, 'teacher', 26, 'teacher', 26, '丰田汽车实训室', 2, '测试课程', 2, '实训内容', 0, 0, '2020-06-15 08:47:34', '2020-06-15 08:47:34', 0, NULL);
INSERT INTO `t_course_arrangement` VALUES (4, 1, '2020年 第19周 (5月4日-5月10日)', '5-6', '测试课程', 3, '15汽检01', '11', NULL, 'admin', 1, 'admin', 1, 'teacher', 26, '吉利实训室', 3, '构件静力分析讲义-1', 1, '测试课程', 0, 0, '2020-06-20 11:09:00', '2020-06-20 11:09:00', 0, NULL);
...
-- ----------------------------
INSERT INTO `t_inspection_plan_year` VALUES (2, 2, '丰田汽车实训室', 'admin', 1, '周', 'inspection_cycle_week', 24, NULL, NULL, NULL, NULL, '2020-06-14 18:12:14', '2020-06-14 18:12:14', '2020');
INSERT INTO `t_inspection_plan_year` VALUES (3, 3, '吉利实训室', 'admin', 1, '月', 'inspection_cycle_month', 12, NULL, NULL, NULL, NULL, '2020-06-20 10:00:45', '2020-06-20 10:00:45', '2020');
...
-- Records of t_tools
-- ----------------------------
INSERT INTO `t_tools` VALUES (1, 'ZY2015000663', '1', '教学用机电实验仪器', '拆装工具', 7700, '2017-12-12', '1', 'YT-5530-YT-5542.YT-55442.YT55444.YT55452', 'admin', 1, '1', '丰田T-TEP整车实训区', '南校区汽车系', 1, '2020-04-22 16:52:00', '2020-04-22 16:52:00', '10', '10', NULL, '10');
